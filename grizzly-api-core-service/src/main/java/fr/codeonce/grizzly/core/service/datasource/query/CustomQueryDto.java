 ...
 */
package fr.codeonce.grizzly.core.service.datasource.query;
...
public class CustomQueryDto {
    ...
    public CustomQueryDto() {
    }

    public CustomQueryDto(String datasource, String database, String collectionName, String query) {
        super();
