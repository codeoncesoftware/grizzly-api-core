...
@RestController
@RequestMapping("/api/projectUsed")
public class ProjectUsedController {

    @Autowired
    private ProjectService projectService;

    @GetMapping("/usedProjects")
    public List<ProjectUse> findAll() {
        return projectService.getAllProjectUsed();
    }
}
