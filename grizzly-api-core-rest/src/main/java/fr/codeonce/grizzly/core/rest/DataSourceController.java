...
public class DataSourceController {
	...
	public Set<String> getCollectionAttributes(@PathVariable("dbsourceId") String dbsourceId,
			@PathVariable("databaseName") String databaseName, @PathVariable("collectionName") String collectionName) {
		log.info(
				"request to get collection stats for datasource with ID : {}, databaseName : {} and collectionName: {}",
				dbsourceId, databaseName, collectionName);
	...
	public DBSource getDBSourceEntity(@RequestParam("dbsourceId") String dbsourceId) {
	...
	public String saveCSVtodatabase(@RequestParam("file") MultipartFile file, @PathVariable String dbSourceId,
