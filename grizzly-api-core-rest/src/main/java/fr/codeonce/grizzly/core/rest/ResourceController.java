...
//	}
    ...
    public RuntimeResource getResource(@RequestParam("containerId") String containerId,
                                       @RequestParam("resourcePath") String resourcePath, @RequestParam("method") String method,
    ...
    public Boolean getUniqueResource(@RequestParam("containerId") String containerId,
                                     @RequestParam("resourcePath") String resourcePath, HttpServletRequest req) {
    ...
    public GridFsResource getResourceForTuntime(@RequestParam("containerId") String containerId,
    ...
    public GridFsResource getResourceWithId(@RequestParam("containerId") String containerId,
